...
| 工具 | 功能 |
|---|---|
| 🎬 视频下载 | 抖音/快手/小红书/B站/微博/知乎/西瓜/头条/微视/AcFun/皮皮虾等 20+ 平台(无水印/B站高清/图文笔记) |
...
| 🔋 充电信息 | 实时显示充电电流/电压/功率/温度与曲线,电池端+充电器输入端(Vbus)双侧数据 |
| 🛰️ 卫星天空图 | 实时显示 GPS/北斗/GLONASS/Galileo 卫星分布,极坐标天空图+信号强度曲线 |
